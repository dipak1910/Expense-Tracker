...
let AddIncome = () => {
    ...
    let addincome = async () => {
        ...
        let colref = collection(db, "income")
                    ...
                    <div className="col-md-12 border-bottom p-0">
                        <input type="text" placeholder="Johnathan Doe" className="form-control p-0 border-0" /> </div>
                                        ...
                                        <div className="form-group mb-4">
                                            ...
                                            <div className="col-md-12 border-bottom p-0">
                                                <input onChange={(e) => setSrc(e.target.value)} type="text" placeholder='Enter Source Of Income' className="form-control p-0 border-0" />
                                            </div>
                                        </div>
                                        <div className="form-group mb-4">
